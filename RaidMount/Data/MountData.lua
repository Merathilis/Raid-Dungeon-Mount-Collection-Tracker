...
RaidMount.mountInstances = {
	...
	-- Shadowlands Raids
	{ mountName = "Sanctum Gloomcharger", MountID = 1500, spellID = 354351, raidName = "Sanctum of Domination", expansion = "Shadowlands", bossName = "The Nine", dropRate = "~1%", difficulty = "Normal", location = "The Maw", description = "Only the Jailer's most powerful lieutenants are gifted these steeds to stalk the halls of the Tower.", statisticIds = { 14455, 14456, 14457, 14458 }, contentType = "Raid", collectorsBounty = true },
	...
	{ mountName = "Sharkbait", MountID = 995, spellID = 254813, raidName = "Freehold", expansion = "Battle for Azeroth", bossName = "Harlan Sweete", dropRate = "~1%", difficulty = "Mythic", location = "Tiragarde Sound", description = "Sharkbait's loyalty lies with whomever keeps the crackers coming.", contentType = "Dungeon", collectorsBounty = "Drop rate not increased in Timewalking" },
	{ mountName = "Tomb Stalker", MountID = 1040, spellID = 266058, raidName = "Kings' Rest", expansion = "Battle for Azeroth", bossName = "King Dazar", dropRate = "~1%", difficulty = "Mythic", location = "Zuldazar", description = "These fierce beasts are entombed alongside kings so they may carry their masters through the afterlife.", contentType = "Dungeon", collectorsBounty = "Drop rate not increased in Timewalking" },
	{ mountName = "Underrot Crawg", MountID = 1053, spellID = 273541, raidName = "The Underrot", expansion = "Battle for Azeroth", bossName = "Unbound Abomination", dropRate = "~1%", difficulty = "Mythic", location = "Nazmir", description = "The eternal twilight of the Underrot has robbed this crawg of all pigmentation.", contentType = "Dungeon", collectorsBounty = true },
