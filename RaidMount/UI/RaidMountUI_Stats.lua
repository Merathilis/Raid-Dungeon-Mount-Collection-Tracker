...
function RaidMount.ShowDetailedStatsView()
	...
	mainTitle:SetFont(cachedFontPath, 18, "OUTLINE")
	...
	overallHeader:SetFont(cachedFontPath, 16, "OUTLINE")
	...
	circleText:SetFont(cachedFontPath, 14, "OUTLINE")
	...
	for _, stat in ipairs(overallStats) do
		...
		statText:SetFont(cachedFontPath, 12, "OUTLINE")
	...
	expansionHeader:SetFont(cachedFontPath, 16, "OUTLINE")
	...
	for i, expansion in ipairs(sortedExpansions) do
		...
		expansionName:SetFont(cachedFontPath, 12, "OUTLINE")
	...
	barChartHeader:SetFont(cachedFontPath, 16, "OUTLINE")
	...
	for i = 1, maxDisplay do
		...
		label:SetFont(cachedFontPath, 10, "OUTLINE")
		...
		attemptText:SetFont(cachedFontPath, 10, "OUTLINE")
