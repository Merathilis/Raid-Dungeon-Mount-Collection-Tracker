...
RaidMount.mountInstances = {
    ...
    -- Classic WoW Raids
    { mountName = "Onyxian Drake", MountID = 349, spellID = 69395, raidName = "Onyxia's Lair", expansion = "Classic", bossName = "Onyxia", dropRate = "~1%", difficulty = "Normal", location = "Dustwallow Marsh", statisticIds = { 1098 }, contentType = "Raid" },
    { mountName = "Fiery Warhorse", MountID = 168, spellID = 36702, raidName = "Karazhan", expansion = "The Burning Crusade", bossName = "Attumen the Huntsman", dropRate = "~1%", difficulty = "Normal", location = "Deadwind Pass", description = "Was one of the most vicious steeds stabled in Karazhan.", statisticIds = { 1088 }, contentType = "Raid" },
    { mountName = "Ashes of Al'ar", MountID = 183, spellID = 40192, raidName = "Tempest Keep", expansion = "The Burning Crusade", bossName = "Kael'thas Sunstrider", dropRate = "~1%", difficulty = "Normal", location = "Netherstorm", description = "Al'ar was the beloved pet of Kael'thas Sunstrider, who often boasted that death would never claim it. Perhaps he was right.", statisticIds = { 1088 }, contentType = "Raid" },
    
    -- Wrath of the Lich King Raids
    { mountName = "Azure Drake", MountID = 246, spellID = 59567, raidName = "Eye of Eternity", expansion = "Wrath of the Lich King", bossName = "Malygos", dropRate = "~1%", difficulty = "Normal", location = "Borean Tundra", description = "Believed to be the most beautiful of all dragonkind, the blues have suffered greatly at the hands of Malygos's madness.", statisticIds = { 1391, 1394 }, contentType = "Raid" },
    ...
    { mountName = "Invincible", MountID = 363, spellID = 72286, raidName = "Icecrown Citadel", expansion = "Wrath of the Lich King", bossName = "The Lich King", dropRate = "~1%", difficulty = "Heroic 25", location = "Icecrown", description = "The famous steed of Arthas Menethil, who serves its master in life and in death.  Riding him is truly a feat of strength.", statisticIds = { 4688 }, contentType = "Raid" },
    { mountName = "Grand Black War Mammoth", MountID = 287, spellID = 61467, raidName = "Vault of Archavon", expansion = "Wrath of the Lich King", bossName = "Any Boss", dropRate = "~1%", difficulty = "Normal", location = "Wintergrasp", statisticIds = { 1753, 1754, 2870, 3236, 4074, 4075, 4657, 4658 }, contentType = "Raid" },
    
    -- Cataclysm Raids
    { mountName = "Drake of the South Wind", MountID = 396, spellID = 88744, raidName = "Throne of the Four Winds", expansion = "Cataclysm", bossName = "Al'Akir", dropRate = "~1%", difficulty = "Normal", location = "Uldum", description = "The South Wind was known in ancient times to bring distress and misfortune to mortals.", statisticIds = { 5976, 5977 }, contentType = "Raid" },
    { mountName = "Pureblood Fire Hawk", MountID = 415, spellID = 97493, raidName = "Firelands", expansion = "Cataclysm", bossName = "Ragnaros", dropRate = "~1%", difficulty = "Normal", location = "Mount Hyjal", description = "Ragnaros the Firelord was among the most ancient and powerful of his kind; a creature of fire and hatred whose very presence scorched the air.", statisticIds = { 5970, 5971 }, contentType = "Raid" },
    { mountName = "Flametalon of Alysrazor", MountID = 425, spellID = 101542, raidName = "Firelands", expansion = "Cataclysm", bossName = "Alysrazor", dropRate = "~1%", difficulty = "Normal", location = "Mount Hyjal", description = "The giant roc Alysrazor soars on wings of flame through skies of fire, raining death on all below.", statisticIds = { 6161, 6162 }, contentType = "Raid" },
    { mountName = "Experiment 12-B", MountID = 445, spellID = 110039, raidName = "Dragon Soul", expansion = "Cataclysm", bossName = "Ultraxion", dropRate = "~1%", difficulty = "Normal", location = "Caverns of Time", description = "An experiment commissioned by Deathwing, this drake was infused with pure twilight energy.", statisticIds = { 6168 }, contentType = "Raid" },
    ...
    { mountName = "Ny'alotha Allseer", MountID = 1293, spellID = 308814, raidName = "Ny'alotha, the Waking City", expansion = "Battle for Azeroth", bossName = "N'Zoth the Corruptor", dropRate = "~1%", difficulty = "Mythic", location = "Uldum/Vale of Eternal Blossoms", description = "To find him, drown yourself in the Circle of Stars.", statisticIds = { 14135, 14136, 14137, 14138 }, contentType = "Raid" },
    ...
    { mountName = "Raven Lord", MountID = 185, spellID = 41252, raidName = "Sethekk Halls", expansion = "The Burning Crusade", bossName = "Anzu", dropRate = "~1%", difficulty = "Heroic", location = "Terokkar Forest", description = "The rest be forgotten to walk upon the ground, clipped wings and shame. -Word of the Raven", contentType = "Dungeon" },
    { mountName = "Swift White Hawkstrider", MountID = 213, spellID = 46628, raidName = "Magister's Terrace", expansion = "The Burning Crusade", bossName = "Kael'thas Sunstrider", dropRate = "~1%", difficulty = "Heroic", location = "Isle of Quel'Danas", description = "I may question Prince Kael'thas's loyalties, but never his style. -Elrodan", contentType = "Dungeon" },
    
    -- Wrath of the Lich King Dungeons
    { mountName = "Blue Proto-Drake", MountID = 264, spellID = 59996, raidName = "Utgarde Pinnacle", expansion = "Wrath of the Lich King", bossName = "Skadi the Ruthless", dropRate = "~1%", difficulty = "Heroic", location = "Howling Fjord", description = "The Storm Peaks! There we will find the beast strong enough to bear me into battle. -Skadi the Ruthless", contentType = "Dungeon" },
    ...
    -- Cataclysm Dungeons
    { mountName = "Vitreous Stone Drake", MountID = 397, spellID = 88746, raidName = "The Stonecore", expansion = "Cataclysm", bossName = "Slabhide", dropRate = "~1%", difficulty = "Heroic", location = "Deepholm", description = "Those would be perfect in a pendant, and that would make a fantastic ring. Let me know if this thing sheds or molts or whatever. -Kalinda", contentType = "Dungeon" },
    { mountName = "Drake of the North Wind", MountID = 395, spellID = 88742, raidName = "The Vortex Pinnacle", expansion = "Cataclysm", bossName = "Altairus", dropRate = "~1%", difficulty = "Heroic", location = "Uldum", description = "They sicken of the calm who know the storm.", contentType = "Dungeon" },
    ...
    -- Legion Dungeons
    { mountName = "Midnight", MountID = 875, spellID = 229499, raidName = "Return to Karazhan", expansion = "Legion", bossName = "Attumen the Huntsman", dropRate = "~1%", difficulty = "Mythic", location = "Deadwind Pass", description = "Still one of the most vicious steeds stabled in Karazhan.", contentType = "Dungeon" },
    ...
    { mountName = "Sharkbait", MountID = 995, spellID = 254813, raidName = "Freehold", expansion = "Battle for Azeroth", bossName = "Harlan Sweete", dropRate = "~1%", difficulty = "Mythic", location = "Tiragarde Sound", description = "A fearsome shark mount that strikes terror into the hearts of sailors.", contentType = "Dungeon" },
    { mountName = "Underrot Crawg", MountID = 1053, spellID = 273541, raidName = "The Underrot", expansion = "Battle for Azeroth", bossName = "Unbound Abomination", dropRate = "~1%", difficulty = "Mythic", location = "Nazmir", description = "The eternal twilight of the Underrot has transformed these creatures into something far more sinister.", contentType = "Dungeon" },
    { mountName = "Tomb Stalker", MountID = 1040, spellID = 266058, raidName = "Kings' Rest", expansion = "Battle for Azeroth", bossName = "King Dazar", dropRate = "~1%", difficulty = "Mythic", location = "Zuldazar", description = "A stealthy mount that prowls the ancient tombs of the Zandalari kings.", contentType = "Dungeon" },
